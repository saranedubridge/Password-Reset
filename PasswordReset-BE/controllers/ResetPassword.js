...
// // define router
// passwordUpdateRouter.post('/', async (request,response)=>{
//     // extract the token  and new passwoed for the request body 
...
//     //  Save the updated user with new hashed pasword
//     await user.save();

//     // Send the sucees response
